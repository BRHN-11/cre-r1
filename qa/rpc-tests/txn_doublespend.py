...
class TxnMallTest(WuzhucoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 WZC:
        ...
        # First: use raw transaction API to send 1210 WZC to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50WZC for another
        ...
        # Node0's total balance should be starting balance, plus 100WZC for 
