...
class TxnMallTest(CowrieTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 COR:
        ...
        # First: use raw transaction API to send 1210 COR to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50COR for another
        ...
        # Node0's total balance should be starting balance, plus 100COR for 
