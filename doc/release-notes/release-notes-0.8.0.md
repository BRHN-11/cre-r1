Wuzhucoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/wuzhucoin/files/Wuzhucoin/wuzhucoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Wuzhucoin
...
New/changed settings (command-line or wuzhucoin.conf file)
--------------------------------------------------------
