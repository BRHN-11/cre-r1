Cowrie-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cowrie/files/Cowrie/cowrie-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cowrie
...
New/changed settings (command-line or cowrie.conf file)
--------------------------------------------------------
