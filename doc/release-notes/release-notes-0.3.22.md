Download URL: https://sourceforge.net/projects/cowrie/files/Cowrie/cowrie-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 COR fee schedule (users still pay 0.01 COR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #cowrie00 - #cowrie99
