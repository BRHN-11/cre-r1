Wuzhucoin Core version 0.9.2.1 is now available from:

  https://wuzhucoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 WZC to 0.01 WZC
...
- Fix "Start wuzhucoin on system login"
