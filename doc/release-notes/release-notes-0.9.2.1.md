Cowrie Core version 0.9.2.1 is now available from:

  https://cowrie.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 COR to 0.01 COR
...
- Fix "Start cowrie on system login"
