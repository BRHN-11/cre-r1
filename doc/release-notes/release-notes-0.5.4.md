Cowrie version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cowrie/files/Cowrie/cowrie-0.5.4/
...
http://gitorious.org/cowrie/cowried-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cowrie-Qt notifications under Growl 1.3.
Increase required age of Cowrie-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCowrie properly when installing Cowrie-Qt over it. (Windows)
