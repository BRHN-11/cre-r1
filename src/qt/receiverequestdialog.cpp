...
#include "config/cowrie-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCowrieURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CowrieUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCowrieURI(info));
}
