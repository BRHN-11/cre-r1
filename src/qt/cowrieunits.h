...
#ifndef COWRIE_QT_COWRIEUNITS_H
#define COWRIE_QT_COWRIEUNITS_H
...
/** Cowrie unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CowrieUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CowrieUnits(QObject *parent);

    /** Cowrie units.
      @note Source: https://en.cowrie.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        COR,
...
typedef CowrieUnits::Unit CowrieUnit;

#endif // COWRIE_QT_COWRIEUNITS_H
