...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/wuzhucoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Wuzhucoin Core"),
     ...
     * override -datadir in the wuzhucoin.conf file in the default data directory
     * (to be consistent with wuzhucoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
