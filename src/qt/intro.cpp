...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/cowrie"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cowrie Core"),
     ...
     * override -datadir in the cowrie.conf file in the default data directory
     * (to be consistent with cowried behavior)
     */
    if(dataDir != getDefaultDataDirectory())
