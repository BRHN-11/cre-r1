...
#ifndef WUZHUCOIN_QT_WUZHUCOINUNITS_H
#define WUZHUCOIN_QT_WUZHUCOINUNITS_H
...
/** Wuzhucoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WuzhucoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WuzhucoinUnits(QObject *parent);

    /** Wuzhucoin units.
      @note Source: https://en.wuzhucoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WZC,
    ...
    //! Number of shells (1e-8) per unit
    ...
    //! Return maximum number of base units (shells)
    static CAmount maxMoney();

private:
    QList<WuzhucoinUnits::Unit> unitlist;
};
typedef WuzhucoinUnits::Unit WuzhucoinUnit;

#endif // WUZHUCOIN_QT_WUZHUCOINUNITS_H
