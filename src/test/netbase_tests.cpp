...
{
    BOOST_CHECK(TestSplitHost("www.wuzhucoin.org", "www.wuzhucoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.wuzhucoin.org]", "www.wuzhucoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.wuzhucoin.org:80", "www.wuzhucoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.wuzhucoin.org]:80", "www.wuzhucoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8244", "127.0.0.1", 8244));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8244", "127.0.0.1", 8244));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8244", "::ffff:127.0.0.1", 8244));
    BOOST_CHECK(TestSplitHost("[::]:8244", "::", 8244));
    BOOST_CHECK(TestSplitHost("::8244", "::8244", -1));
    BOOST_CHECK(TestSplitHost(":8244", "", 8244));
    BOOST_CHECK(TestSplitHost("[]:8244", "", 8244));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8244", "127.0.0.1:8244"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8244", "[::]:8244"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
