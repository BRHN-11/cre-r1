 ...
 * for both cowried and cowrie-core, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/cowrie/bips/blob/master/bip-0014.mediawiki)
 */
