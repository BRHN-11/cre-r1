...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cowrie Core cowrie-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cowrie-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cowrie transaction") + "\n" +
              "  cowrie-tx [options] -create [commands]   " + _("Create hex-encoded cowrie transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cowrie transaction
